...
wget https://github.com/addictgamer/Barony/releases/download/ci-deps-v1.0/dependencies.zip.enc -O dependencies.zip.enc
RESULT=$?
if [ $RESULT -ne 0 ]; then
...
# TODO: Don't forget to install (via apt) the open-source dependencies!
